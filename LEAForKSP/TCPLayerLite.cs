...
namespace LEAForKSP
{
    ...
    class TCPLayerLite
    {
        ...
        /// <summary>
        /// This function returns only when all connected devices are ready.
        /// </summary>
        /// <param name="timeout">Timeout</param>
        /// <returns>Return true if all devices are ready before timeout, else return false</returns>
        public static bool waitForDevicesToBeReady(TimeSpan timeout)
        {
            DateTime endOfWait = DateTime.Now + timeout;
            while (DateTime.Now < endOfWait)
            {
                bool result = true;
                lock (connectedDevices)
                {
